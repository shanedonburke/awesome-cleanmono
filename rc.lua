...
beautiful.init("/home/shane/.config/awesome/themes/cleanmono/theme.lua")
...
-- mytextclock = wibox.widget.textclock(" <b>%a %h %d %I:%M %p</b> ", 60, "0:00")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            wibox.layout.margin(systray, 3, 10, 7, 3),
            separator,
            mytextclock,
            wibox.layout.margin(s.mylayoutbox, 10, 3, 3, 3),
        },
    }
end)
-- }}}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           "Control"}, "Tab", awful.tag.history.restore,
              {description = "go to last viewed tag", group = "tag"}),
    ...
    --         end
    --     end,
    --     {description = "next tag", group = "layout"}),
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c, {
        ...
        { -- Left
            -- wibox.layout.margin(awful.titlebarr.widget.iconwidget(c), 0, 5, 5, 3),
            buttons = buttons,
            layout  = wibox.layout.fixed.horizontal
        },
        { -- Middle
        ...
        --    awful.titlebar.widget.ontopbutton    (c),
            wibox.layout.margin(awful.titlebar.widget.minimizebutton(c), 2.5, 2.5, 10, 10),
            wibox.layout.margin(awful.titlebar.widget.maximizedbutton(c), 2.5, 2.5, 10, 10),
            wibox.layout.margin(awful.titlebar.widget.closebutton(c), 2.5, 10, 10, 10),
            layout = wibox.layout.fixed.horizontal()
        },
        layout = wibox.layout.align.horizontal
    }
